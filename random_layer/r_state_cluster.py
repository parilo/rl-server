...
from .r_cluster_rmse import RClusterRMSE

class RStateCluster (RClusterRMSE):
    ...
    def __init__ (self, train_loop):
        ...
        # mean_state_val = np.array([0.0] * train_loop.observation_size)
        # std_state_val = np.array([1.0] * train_loop.observation_size)

        mean_state_val = np.array([ 0.03214955,  0.63724426, -0.08213178, -0.39726306,  0.08072493,  0.06040303,
  0.00603976,  0.01115955, -0.00083882, -0.00167864, -0.00352362, -0.00486504,
  0.00319279,  0.00260848,  0.00225991,  0.00347986])

        std_state_val = np.array([ 0.31228413,  0.28795486,  0.59377874,  0.38100948,  0.44665399,  0.30644209,
  0.07748083,  0.10504769,  0.00601454,  0.0642904,   0.04020265,  0.05460484,
  0.01748952,  0.16866262,  0.05634506,  0.07737991])
